---
name: build-and-test
description: Builds everything and runs all tests the way CI does, reporting failures verbatim. Use when the user asks to build, test, verify, or prepare Oltre for a PR.
when_to_use: Use when the user asks to build, test, verify, or prepare Oltre for a PR.
user-invocable: true
---
