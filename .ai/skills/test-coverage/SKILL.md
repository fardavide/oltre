---
name: test-coverage
description: Oltre's unit, integration, screenshot, and behaviour test categories and per-kind coverage reporting. Use when naming tests, choosing test scope, diagnosing coverage changes, or considering thresholds.
when_to_use: >
