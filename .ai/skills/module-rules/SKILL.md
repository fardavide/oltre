---
name: module-rules
description: Oltre's eight enforced module rules — layout, layer edges, fakes that must not ship, and the sealed dependency graph. Use before creating modules or project dependencies, or when module-layout checks fail.
when_to_use: >
