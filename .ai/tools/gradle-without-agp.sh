...
# never here. See `.ai/rules/session-roles.md`.
#
...
# USAGE
#
#   .ai/tools/gradle-without-agp.sh :sim:run
#   .ai/tools/gradle-without-agp.sh :core:jvmTest :sim:test
#   .ai/tools/gradle-without-agp.sh :server:test
#   .ai/tools/gradle-without-agp.sh :client:debug:domain:desktopTest
#   .ai/tools/gradle-without-agp.sh :core:jvmTest --tests '*BalanceCurveTest*'
#
set -uo pipefail
...
FILES=(
  ...
  client/alliance/data/build.gradle.kts
  client/alliance/domain/build.gradle.kts
...
// OVERLAY — generated by .ai/tools/gradle-without-agp.sh, never committed.
//
...
cat > client/alliance/domain/build.gradle.kts <<'OVERLAY'
// OVERLAY — generated by .ai/tools/gradle-without-agp.sh, never committed.
...
cat > client/alliance/data/build.gradle.kts <<'OVERLAY'
// OVERLAY — generated by .ai/tools/gradle-without-agp.sh, never committed.
plugins { alias(libs.plugins.kotlinMultiplatform) }
kotlin {
    jvmToolchain(21)
