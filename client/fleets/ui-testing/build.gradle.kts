// The Fleets robot, and it is a module rather than a file for the reason
...
//
// The two are `:client:fleets:ui`, whose behaviour and screenshot tests drive the screen from
// hand-written frames, and `:client:fleets:presentation`, whose `FleetsFromStateBehaviourTest`
    ...
    sourceSets {
        val desktopMain by getting {
            dependencies {
                ...
                // plugin at all: `fleets(uiState) { … }` names a `FleetsUiState` and hands back a
