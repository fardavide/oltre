...
// no picker, no settings surface, no design round trip — so the decision reduces to this function,
// and the shell's job is to read a tag and hand the answer to the two things that need it.
//
