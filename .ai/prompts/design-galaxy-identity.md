...
`.ai/docs/galaxy-identity-sheet.md`. Local→Design is a **round trip**: the local session waits for
...
WHAT IS BEING BUILT — read `.ai/docs/galaxy-identity-sheet.md` in full; this is the summary
