...
**In the chat and nowhere else — it is not written to a file** (Davide, 2026-08-23). `.ai/prompts/`
...
carries instead is the section naming what the round trip was for — see
[`../docs/ask-once-sheet.md`](../docs/ask-once-sheet.md), *"What the round trip was for"*.
