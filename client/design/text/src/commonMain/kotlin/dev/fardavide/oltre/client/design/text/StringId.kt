...
enum class StringId {
    ...
    TabShips,
    TabAlliance,
    AllianceComingSoonTitle,
    AllianceComingSoonBody,
    // ── The alliance ────────────────────────────────────────────────────────────────────────
    //
    // **The destination is two screens chosen by account state, never a toggle** —
    // `alliance-sheet.md` §7. Not in an alliance: a search and a founding block. In one: the
    // roster, the treasury and the projects, with the pending requests above them for a founder.
    AllianceAsking,
    AllianceSearchLabel,
    AllianceSearchIdle,
    AllianceSearchEmpty,
    ...
    AllianceFoundName,
    AllianceFoundTag,
    AllianceFoundTagRule,
    AllianceFoundPrice,
    AllianceFoundPriceUnread,
    AllianceFoundShort,
    AllianceFoundAction,
    AllianceNameTaken,
    AllianceTagTaken,
    ...
    AllianceSeatsLine,
    AllianceLevelBadge,
    AlliancePendingLabel,
    AlliancePendingEmpty,
    AllianceAccept,
    AllianceDecline,
    AllianceRosterLabel,
    AllianceRoleFounder,
    ...
    AllianceShareAll,
    AllianceShare,
    AllianceContributeAction,
    AllianceContributeNothing,
    AllianceShareRoundsToNothing,
    AllianceConfirmAllTitle,
    AllianceConfirmAllBody,
    AllianceConfirmAllAction,
    AllianceConfirmAllKeep,
    AllianceProjectsLabel,
    AllianceProjectsEmpty,
    RefusedAllianceLead,
    RefusedAllianceShortBody,
    RefusedAllianceStandingBody,
    RefusedAllianceOutdatedBody,
    RefusedAllianceServerBody,
    ...
    AllianceLeaveAction,
    AllianceDisbandAction,
    RefusedContributionLead,
    RefusedContributionBody,
    Watching,
    RatePerHour,
    ResourceRailMetal,
    ResourceRailCrystal,
