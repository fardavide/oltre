...
| Where the ledger lives | *"Should we ask Design?"* — **yes**, and it went in the round trip with the portrait and the strip. `.ai/prompts/design-galaxy-identity.md` |
...
(`.ai/prompts/design-galaxy-identity.md`). The third option is the strongest answer to the
