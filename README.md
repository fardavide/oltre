...
- **You are already several levels in.** The level is read from your colony's own history rather than
  stored, so opening this build credits you for everything you did before it existed. Nothing was
  reset and nothing was invented — every survey, run and upgrade you have ever finished counts.
