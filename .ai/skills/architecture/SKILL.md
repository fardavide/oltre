---
name: architecture
description: Oltre's module map and dependency rule — core purity, the client module family, where new code goes, and how to add a feature module. Use before creating files, adding dependencies, or deciding where a feature, rule, or adapter belongs.
when_to_use: >
