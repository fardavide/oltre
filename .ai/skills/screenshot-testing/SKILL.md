...
description: Oltre's Roborazzi workflow — desktop screenshot tests, local baselines, and CI verification. Use when changing covered Compose UI, adding or updating baselines, or diagnosing screenshot failures.
when_to_use: >
