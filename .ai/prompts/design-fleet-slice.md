...
`.ai/docs/fleet-sheet.md`. Local→Design is a **round trip**: the local session waits for the sheet
...
WHAT IS BEING BUILT — read `.ai/docs/fleet-sheet.md` in full; this is the summary
