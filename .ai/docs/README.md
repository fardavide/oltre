...
| [alliance-sheet.md](alliance-sheet.md) | **Eleven calls taken, nothing built.** The 0.23 design — why an alliance between separate galaxies is a treasury rather than a convoy, what its level runs on, why production perks are held, and the nine slices that are #136 |
