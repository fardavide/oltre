...
//
// `pendingWork` is null once a tab has a real screen behind it — today the Colony and Research do,
// and this table is the honest record of that. The strings are **placeholder copy**: what a screen
