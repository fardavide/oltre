---
name: versioning
description: Oltre's version-bump, changelog, and post-merge tagging convention. Use before changing the version, cutting a release, or opening a PR with user-visible behavior.
when_to_use: >
...
given. Both are in `.ai/docs/decisions.md`.
